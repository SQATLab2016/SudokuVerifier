...
public class SudokuVerifierTest {
	...
	@Test
	public void testVerify_VerifyAllRule() {
		assertTrue(sudokuVerifier
				.verify("417369825632158947958724316825437169791586432346912758289643571573291684461875293") == RULE_1_VOILATION_RESULT
				|| sudokuVerifier
						.verify("417369825632158947958724316825437169791586432346912758289643571573291684461875293") == RULE_2_VOILATION_RESULT
				|| sudokuVerifier
						.verify("417369825632158947958724316825437169791586432346912758289643571573291684461875293") == RULE_3_VOILATION_RESULT
				|| sudokuVerifier.verify(
						"417369825632158947958724316825437169791586432346912758289643571573291684461875293") == RULE_4_VOILATION_RESULT);
	}
}
